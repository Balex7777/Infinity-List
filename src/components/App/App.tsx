...
import { List, Skeleton, Layout, Flex, Radio, Typography } from 'antd';
	...
	async function fetchItems(page: number, sort: string) {
		try {
			const response = await axios.get(
				`https://api.github.com/search/repositories?q=javascript&${sort}order=asc&page=${page}`
			);
		...
		<Layout className="layout">
			...
			<Footer className="footer">
				<Flex justify="space-between">
					...
					<p>
						My{' '}
						<a href="https://github.com/Balex7777" className="footer__github">
							GitHub
						</a>
					</p>
				</Flex>
